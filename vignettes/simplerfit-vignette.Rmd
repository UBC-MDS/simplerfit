...
## Brief Introduction
Simplerfit will help reduce effort in each section of a model building pipeline. There are five functions that are included in this R package which are described in more detail below. Seasoned and amateur data scientists' can use this package in their pipelines to make their tasks more efficient.
